...
# /AGENTS.md
Rules: Repository-wide guidance for this monorepo example.
- Keep edits scoped to the smallest subtree that owns the behavior.
- Prefer internal shared modules (`/packages/*`) over duplicated app-local utilities.
- When changing API behavior, verify request handlers and storage shape remain consistent.
