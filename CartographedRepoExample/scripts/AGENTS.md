...
Rules: quality-gate script constraints.

- Keep script behavior deterministic and suitable for CI and local invocation.
- Keep scan directories explicit and update them when repository layout changes.
- Surface actionable failures with nonzero exit codes and concise stderr messaging.
