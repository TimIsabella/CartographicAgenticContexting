...
Rules: documentation subtree constraints.

- Keep release notes and human-facing operational notes under `docs/`.
- Prefer concise entries tied to concrete changes and dates.
- Avoid duplicating code-level guidance already covered by tree artifacts in source subtrees.
