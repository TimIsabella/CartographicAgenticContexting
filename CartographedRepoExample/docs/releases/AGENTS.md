...
Rules: Release notes guidance.
- Keep release note files focused on user-visible changes and verification results.
- Use one file per release version under this subtree.
