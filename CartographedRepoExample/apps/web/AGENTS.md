...
# /apps/web/AGENTS.md
Rules: Web client guidance.
- Keep browser UI changes scoped to `apps/web/*` and avoid duplicating API domain logic from `apps/api`.
- When API usage changes, verify request paths and payload handling in `apps/web/src/app.js`.
