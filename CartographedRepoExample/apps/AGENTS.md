...
# /apps/AGENTS.md
Rules: App-layer boundaries.
- Keep server concerns in `/apps/api` and browser concerns in `/apps/web`.
- Do not introduce package-private logic into app directories when a shared package boundary exists.
