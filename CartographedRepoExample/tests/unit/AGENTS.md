...
Rules: unit-test constraints.

- Keep tests focused on isolated module behavior with minimal external dependencies.
- Validate error handling and edge-case behavior for utility functions and adapters.
- Keep assertions deterministic and independent of sibling test execution order.
