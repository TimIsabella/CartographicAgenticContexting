...
Rules: Logging and redaction behavior.
- Extend `SENSITIVE_KEY_PATTERN` when adding new credential-like fields.
- Preserve redaction before serialization for all structured event payloads.
Validate: `node --check packages/observability/logger.js`
