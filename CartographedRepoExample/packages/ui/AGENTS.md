...
Rules: Shared UI module guidance.
- Keep package exports reusable across apps and avoid app-specific dependencies.
- When component APIs change, update web consumers in the same change.
