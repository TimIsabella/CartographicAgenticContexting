...
Rules: Persistence layer guidance.
- Keep storage schema and serialization behavior consistent with API handler expectations.
- When changing stored shape or defaults, update related API handlers and tests in the same change.
