...
# /packages/AGENTS.md
Rules: Shared package guidance.
- Keep shared module APIs stable and version changes by behavior compatibility.
- Put reusable behavior in packages and consume it from apps instead of duplicating module logic.
