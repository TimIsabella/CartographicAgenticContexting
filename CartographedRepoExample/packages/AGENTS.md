...
# /packages/AGENTS.md
Rules: Shared package boundaries.
- Keep shared utilities dependency-light and side-effect constrained.
- Keep package APIs small and imported by apps through explicit module paths.
